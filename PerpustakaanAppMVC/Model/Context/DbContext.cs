    ...
    public class DbContext : IDisposable
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"F:\MATERI\S3\PEMOGRAMAN LANJUT\#22.11.4833\p11\Operasi CRUD MVC Part #2\Operasi CRUD MVC Part #2\PerpustakaanAppMVC\Database\DbPerpustakaan.db";
